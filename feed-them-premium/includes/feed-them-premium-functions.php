...
<div class="slickremix-widget-header-wrap">
<h2 class="fts-widget-header-h2">Feed Them Social</h2>
<h2 class="fts-widget-header-h3">FB Page Feed</h2>
</div>
<div class="fts-label-input-wrap">
  <label for="<?php echo $this->get_field_id('title'); ?>">Your Title:</label>
  <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr__($title); ?>" />
...
<div class="fts-label-input-wrap">
  <label for="<?php echo $this->get_field_id('facebook_page_name'); ?>">Facebook Page Name (required)</label>
...
<div class="fts-label-input-wrap">
  <label for="<?php echo $this->get_field_id('fb_page_posts_displayed'); ?>">Post Type Visible</label>
  <select id="<?php echo $this->get_field_id('fb_page_posts_displayed'); ?>" name="<?php echo $this->get_field_name('fb_page_posts_displayed'); ?>"  class="widefat" size="1">
    <option value="page_only" <?php selected('page_only', $instance['fb_page_posts_displayed']); ?>>Display Posts made by Page only</option>
    <option value="everyone" <?php selected('everyone', $instance['fb_page_posts_displayed']); ?>>Display Posts made by Everyone</option>
  </select>
</div>
<!--/feed-them-social-admin-input-wrap-->
<div class="fts-label-input-wrap">
  <label for="<?php echo $this->get_field_id('number_of_posts'); ?>">Number of posts (required)</label>
...
<div class="fts-label-input-wrap">
  <label for="<?php echo $this->get_field_id('fb_page_title'); ?>">Show page title</label>
  <select id="<?php echo $this->get_field_id('fb_page_title'); ?>" name="<?php echo $this->get_field_name('fb_page_title'); ?>" class="widefat" size="1">
    <option value="yes" <?php selected('yes', $instance['fb_page_title']); ?>>yes</option>
    <option value="no" <?php selected('no', $instance['fb_page_title']); ?>>no</option>
  </select>
</div>
<div class="fts-label-input-wrap">
  <label for="<?php echo $this->get_field_id('fb_page_description'); ?>">Show page description</label>
  <select id="<?php echo $this->get_field_id('fb_page_description'); ?>" name="<?php echo $this->get_field_name('fb_page_description'); ?>" class="widefat" size="1">
    <option value="yes" <?php selected('yes', $instance['fb_page_description']); ?>>yes</option>
    <option value="no" <?php selected('no', $instance['fb_page_description']); ?>>no</option>
  </select>
</div>
<div class="fts-label-input-wrap last">
  <label for="<?php echo $this->get_field_id('fb_page_word_count'); ?>">Number of words per post (required)</label>
...
<div class="fts-label-input-wrap last">
  <label for="<?php echo $this->get_field_id('fb_group_word_count'); ?>">Number of words per post (required)</label>
...
<div class="slickremix-widget-header-wrap">
<h2 class="fts-widget-header-h2">Feed Them Social</h2>
<h2 class="fts-widget-header-h3">FB Event Feed</h2>
</div>
<div class="fts-label-input-wrap">
  <label for="<?php echo $this->get_field_id('title'); ?>">Your Title:</label>
  <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr__($title); ?>" />
...
<div class="fts-label-input-wrap">
  <label for="<?php echo $this->get_field_id('facebook_event_name'); ?>">Facebook Event ID (required)</label>
...
<div class="fts-label-input-wrap">
  <label for="<?php echo $this->get_field_id('fb_event_title'); ?>">Show event title</label>
  <select id="<?php echo $this->get_field_id('fb_event_title'); ?>" name="<?php echo $this->get_field_name('fb_event_title'); ?>" class="widefat" size="1">
    <option value="yes" <?php selected('yes', $instance['fb_event_title']); ?>>yes</option>
    <option value="no" <?php selected('no', $instance['fb_event_title']); ?>>no</option>
  </select>
</div>
<div class="fts-label-input-wrap">
  <label for="<?php echo $this->get_field_id('fb_event_description'); ?>">Show event description</label>
  <select id="<?php echo $this->get_field_id('fb_event_description'); ?>" name="<?php echo $this->get_field_name('fb_event_description'); ?>" class="widefat" size="1">
    <option value="yes" <?php selected('yes', $instance['fb_event_description']); ?>>yes</option>
    <option value="no" <?php selected('no', $instance['fb_event_description']); ?>>no</option>
  </select>
</div>
<div class="fts-label-input-wrap last">
  <label for="<?php echo $this->get_field_id('fb_event_word_count'); ?>">Number of words per post (required)</label>
